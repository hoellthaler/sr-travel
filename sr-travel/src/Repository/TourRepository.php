...
class TourRepository extends ServiceEntityRepository
{
    ...
    public function findLastThreeToursForReisebegleiter(int $reisebegleiterId)
    {
        return $this->createQueryBuilder('t')
            ->andWhere('t.reisebegleiter = :reisebegleiterId')
            ->setParameter('reisebegleiterId', $reisebegleiterId)
